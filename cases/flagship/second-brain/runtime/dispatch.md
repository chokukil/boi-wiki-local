# Runtime dispatch — Flagship Second Brain
...
- [source-curator](../roles/source-curator.md)
- [knowledge-distiller](../roles/knowledge-distiller.md)
- [memory-maintainer](../roles/memory-maintainer.md)
- [grounded-query-analyst](../roles/grounded-query-analyst.md)
- [privacy-reviewer](../roles/privacy-reviewer.md)
