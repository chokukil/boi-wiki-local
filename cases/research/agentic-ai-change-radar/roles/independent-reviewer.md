...
description: "원문 record와 manifest부터 재검토해 approve·revise·partial·blocked 판정"
...
원문 record와 manifest부터 재검토해 approve·revise·partial·blocked 판정

## 허용 입력

- T0/T1 records, manifest, evidence, change set
...
중요 claim과 contradiction의 evidence locator가 독립 확인됨

## Hard fail

producer 요약만 읽거나 self-approval
