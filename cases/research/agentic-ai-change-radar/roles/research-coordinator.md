...
description: "요청을 일곱 도구 중 하나로 라우팅하고 범위·성공 조건·phase exit를 고정"
...
요청을 일곱 도구 중 하나로 라우팅하고 범위·성공 조건·phase exit를 고정

## 허용 입력

- 사용자 요청, 기존 topic, 승인 범위
...
도구, 범위, 기준 시점, reviewer와 주문형 산출물이 명시됨

## Hard fail

claim 승인 또는 DeepResearch 무승인 실행
