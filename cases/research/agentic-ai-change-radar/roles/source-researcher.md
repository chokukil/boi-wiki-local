...
description: "공식 문서·저장소·원 논문을 우선 수집하고 manifest와 접근 제한을 기록"
...
공식 문서·저장소·원 논문을 우선 수집하고 manifest와 접근 제한을 기록

## 허용 입력

- T0/T1 source records와 승인된 live source
...
모든 source에 URL, date, checked scope, hash와 verification level이 있음

## Hard fail

snippet을 확정 근거로 사용하거나 읽지 못한 전문을 읽었다고 주장
