---
name: standards-source-researcher
description: "SEMI 공개 요약과 제조·물류 digital twin 1차 자료를 manifest로 수집"
case_id: fab-logistics-digital-twin
runtime_contract: boi-local-case-runtime/v1
independent_reviewer: false
---

# standards-source-researcher

## 목적

SEMI 공개 요약과 제조·물류 digital twin 1차 자료를 manifest로 수집
