---
name: twin-model-analyst
description: "Carrier·Substrate·Control Job, 물류 자산·상태·event·simulation을 capability map으로 연결"
...
Carrier·Substrate·Control Job, 물류 자산·상태·event·simulation을 capability map으로 연결
...
- 주 산출물: `intermediate/twin-capability-map.md`
...
관측 사실, 표준 개념, vendor claim과 가설이 구분됨

## Hard fail

공개 case signal을 SK하이닉스 성과로 일반화
