# Orchestrator — Scientific Foundation Model Knowledge
...
flowchart TD
    ...
    B --> C["paper-source-researcher: source manifest"]
    C --> D["post-write fast gate"]
    D --> E["scientific-evidence-analyst: evidence·unknown"]
    E --> F["change-curator: delta·history"]
    F --> G["scoped lint"]
