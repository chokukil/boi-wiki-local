...
description: "논문 record와 실제 확인 범위부터 prediction·반례·재현 상태를 검토"
...
논문 record와 실제 확인 범위부터 prediction·반례·재현 상태를 검토

## 허용 입력

- manifest, matrix, delta
...
근본 법칙, 모델 가정, empirical claim과 unknown이 구분됨

## Hard fail

producer 해석 또는 인용 횟수만으로 승인
