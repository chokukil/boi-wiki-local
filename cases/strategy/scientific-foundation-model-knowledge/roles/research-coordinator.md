...
description: "연구 질문, discipline, validation level, review trigger와 주문 산출물을 고정"
...
연구 질문, discipline, validation level, review trigger와 주문 산출물을 고정

## 허용 입력

- 사용자 질문과 기존 paper graph
- 현재 run이 잠근 user prompt, fixture/seed manifest, 허용 source subset만 읽는다.
- Local Private source를 원격 도구에 보내지 않는다.

## 산출물 계약

- 주 산출물: `intermediate/request-contract.json`
...
근본 법칙과 빠른 동향의 검토 주기가 분리됨

## Hard fail

모든 분야를 하나의 foundation claim으로 합침
