...
description: "법칙, model assumption, prediction, benchmark, physical validation, 반례를 분리"
...
법칙, model assumption, prediction, benchmark, physical validation, 반례를 분리

## 허용 입력

- source manifest와 기존 claims
- 현재 run이 잠근 user prompt, fixture/seed manifest, 허용 source subset만 읽는다.
- Local Private source를 원격 도구에 보내지 않는다.

## 산출물 계약

- 주 산출물: `intermediate/scientific-evidence-matrix.md`
...
주장마다 적용 domain과 falsifier가 있음

## Hard fail

성능을 물리적 정확성 또는 인과로 동일시
