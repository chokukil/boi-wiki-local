# Runtime dispatch — Scientific Foundation Model Knowledge
...
- [paper-source-researcher](../roles/paper-source-researcher.md)
- [scientific-evidence-analyst](../roles/scientific-evidence-analyst.md)
- [change-curator](../roles/change-curator.md)
