...
- `scripts/case_harness_check.py`: 4 Cases pass, Global Insight 3 Cases는 각 `community`, completed execution 0/60
...
4. 세 Case에서 stable operation, baseline improvement와 cross-Case regression이 확인된 경우에만 generic Skill을 제안합니다.
